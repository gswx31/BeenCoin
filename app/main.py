...
from app.routers import auth, orders, account, websocket, alerts, analytics, leaderboard, achievements, market, backtest, engagement, futures, bankruptcy
...
app.include_router(bankruptcy.router, prefix=settings.API_V1_STR)
